  ...
  const services = [
    {
      ...
      desc: "One-on-one sessions for hitting, pitching, catching, and fielding.",
      icon: "⚾",
    },
    {
      title: "Catcher Training",
      desc: "Specialized instruction on blocking, receiving, and mechanics.",
      icon: "🧤",
    },
    {
      title: "Team Training",
      desc: "Customized coaching programs for teams looking to level up.",
      icon: "👥",
    },
    {
      title: "Group Clinics",
      desc: "Seasonal camps that teach skills and teamwork in a fun environment.",
      icon: "🏫",
    },
    {
      title: "Strength & Agility",
      desc: "Building speed and endurance in our exclusive training area.",
      icon: "⚡",
    },
    {
      title: "Nutrition & Wellness",
      desc: "Fuel properly and recover smarter with expert guidance.",
      icon: "🥗",
    },
  ];
  ...
  const galleryImages = [
    {
      ...
      alt: "Training area showing baseball equipment",
    },
          ...
          <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
            <p>
              ...
              <span className="font-semibold text-slate-900">
                Miguel and Francisca Olivo
              </span>
              , who share a commitment to helping young athletes grow
              stronger—physically, mentally, and emotionally—on and off the
              field.
            </p>
            <p>
              ...
              competition. We focus on fundamentals, advanced skills, strength
              and agility, and the mental side of the game, all while creating a
      ...
      <section className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="p-8 rounded-2xl border border-slate-100 bg-white shadow-sm hover:border-orange-500/30 transition-all"
            >
      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryImages.map((img, i) => (
            <div
              key={i}
              className="group relative aspect-square md:aspect-video overflow-hidden rounded-xl bg-slate-100 shadow-sm border border-slate-100"
            >
              <Image
                src={img.src}
                alt={img.alt}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <article className="group">
            ...
            <p className="text-slate-600 leading-relaxed">
              Miguel Olivo brings over 14 years of experience as an MLB catcher.
              He uses his lifetime of knowledge to train the next generation
              with the same passion and attention to detail that defined his
              professional career.
            </p>
          </article>
          ...
          <article className="group">
            ...
            <p className="text-slate-600 leading-relaxed">
              Francisca is a certified nutritionist and 2024 Women in Supply
              Chain Award winner. At BMO Elite, she leads efforts in athlete
              wellness, nutrition, and strategic growth with a deep care for
              people.
            </p>
          </article>
          ...
          <article className="group">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              years of experience training athletes in{" "}
              <span className="text-orange-600 font-medium">
                Pitching, Hitting, and Speed & Agility.
              </span>
            </p>
          </article>
        </div>
            ...
            <address className="not-italic space-y-4 text-slate-300">
              ...
              <div className="pt-4 space-y-2">
                <p>
                  ...
                  <a
                    href="tel:6812601421"
                    className="text-orange-400 hover:text-white transition-colors underline"
                  >
                    681-260-1421
                  </a>{" "}
                  |{" "}
