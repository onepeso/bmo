        ...
        <div className="bg-gray-100 text-gray-800 min-h-screen py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-6">
                <h1 className="text-2xl font-bold mb-4">
                    Privacy Policy for BMO Elite Performance Indoor Baseball/Softball Training Center
                </h1>
                ...
                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">2. Scope of This Policy</h2>
                ...
                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">3. Children Under the Age of 13</h2>
                    <p>
                ...
                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">4. Information We Collect About You and How We Collect
                        It</h2>
                    <p>
                    ...
                    <ul className="list-disc ml-6 space-y-2">
                        ...
                        <li>About your internet connection, the equipment you use to access our Website...</li>
                    </ul>
                </section>

                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">5. Information You Provide to Us</h2>
                    <p>The information we collect on or through our Website may include:</p>
                    <ul className="list-disc ml-6 space-y-2">
                        <li>
                            Information you provide by filling in forms on our Website. This includes information
                            provided at the time of registering to use our Website, subscribing to our service...
                        </li>
                        <li>Your responses to surveys that we might ask you to complete for research purposes.</li>
                        <li>Details of transactions you carry out through our Website and the fulfillment of your
                            orders.
                        </li>
                    </ul>
                </section>
                ...
                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">6. Information We Collect Through Automatic Data
                        Collection Technologies</h2>
                    <p>
                ...
                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">7. Third-party Use of Cookies and Other Tracking
                        Technologies</h2>
                    <p>
                ...
                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">8. How We Use Your Information</h2>
                    <p>
                        We use information that we collect about you or that you provide to us, including any personal
                        information, for several purposes such as presenting our Website, providing you with
                        information,
                        and fulfilling any purpose for which you provide it.
                    </p>
                </section>

                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">9. Disclosure of Your Information</h2>
                    <p>
                        We may disclose personal information that we collect or you provide as described in this privacy
                        policy to our subsidiaries, affiliates, contractors, service providers, or third parties that
                        support
                ...
                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">10. Choices About How We Use and Disclose Your
                        Information</h2>
                    <p>
                        We strive to provide you with choices regarding the personal information you provide to us. You
                        can
                        set your browser to refuse cookies and can control other privacy preferences.
                    </p>
                </section>

                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">11. Accessing and Correcting Your Information</h2>
                    <p>
                        You may send us an e-mail via our contact link to request access to, correct, or delete any
                        personal
                ...
                <section className="mb-6">
                    <h2 className="text-xl font-semibold mb-2">13. Changes to Our Privacy Policy</h2>
                    <p>
                ...
                <section className="mb-6">
                    ...
                    <p>
                        To ask questions or comment about this privacy policy and our privacy practices, please contact
                        us
